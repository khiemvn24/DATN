...
const FoodCart1 = ({item,onPressRestaurant}) => {
//   console.log(item, '==================klklkk')
  return (
    <TouchableOpacity  onPress={onPressRestaurant}>
      <View style={{...style.cardView, width: SCREEN_WIDTH * 0.95}}>
        <Image
          style={{...style.image, width: SCREEN_WIDTH * 0.95}}
